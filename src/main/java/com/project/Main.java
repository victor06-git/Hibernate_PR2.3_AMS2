...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Inicialitzem Hibernate - Si falla aquí, revisa les anotacions @Entity a les
        // entitats
        ...
        // Prerequisit: Les entitats Autor i Llibre han de tenir @Entity, @Id,
        // @GeneratedValue
        // ---------------------------------------------------------
        ...
        System.out.println(
                "Préstec rebutjat correctament: " + (prestecFallat == null ? "OK" : "ERROR - Hauria de ser null!"));
